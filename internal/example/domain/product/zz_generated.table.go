...
func (Product) UniqueIndexes() sqlbuilder.Indexes {
...
type tableProduct struct {
	...
	// 编码
	Code modelscoped.TypedColumn[Product, productv1.ProductCode]
...
var ProductT = &tableProduct{
	...
	Code:        modelscoped.CastTypedColumn[Product, productv1.ProductCode](modelscoped.FromModel[Product]().F("Code")),
	...
	I: indexesOfProduct{
		...
		ICode:   modelscoped.FromModel[Product]().MK("i_code"),
	},
}
