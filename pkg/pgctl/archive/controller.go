...
func (c *Controller) ImportArchiveFromTar(ctx context.Context, code archivev1.ArchiveCode, o io.ReadCloser) error {
	return internal.Untar(o, c.DataDir.PgArchivePath(string(code)))
}
